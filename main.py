...
def main(args):
    ...
    #lr_scheduler = GradualWarmupScheduler(optimizer, multiplier=1, total_epoch=5, after_scheduler=prev_lr_scheduler)
    if args.distributed:
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        for k, v in train_stats.items():
            if k=='class_error':
                log_data['train_class_error'] = v
            if k=='loss':
                log_data['train_loss'] = v
